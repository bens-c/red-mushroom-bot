...
export function getCollection(name) {
  ...
  const allowed = ['moderation_cases', 'levels', 'level_roles', 'giveaways', 'tickets', 'reminders', 'backups', 'afk', 'custom_commands', 'stickies', 'reaction_roles', 'automod_violations', 'staff_roles', 'staff_movements', 'application_categories'];
