...
test('includes every all-in-one module command group', () => {
  ...
  for (const expected of ['application', 'staff-roles', 'maintenance', 'customise', 'clear', 'moderation', 'level', 'giveaway', 'ticket', 'backup', 'sticky', 'reaction-role', 'automod', 'community']) {
